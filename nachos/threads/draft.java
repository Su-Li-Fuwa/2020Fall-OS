public class Condition2Test {
    ...
    public void simpleCondition2Test(){
        ...
        KThread thread2 = new KThread(new Runnable(){
            public void run(){
                new SaveThread("hh",myCount,1000);
                System.out.println("hh goes to sleep");
                conlock.acquire();
                c2test.sleep();
                System.out.println("hh reacquires lock when woken.");
                conlock.release();
                System.out.println("hh is awake!");
                myCount.save(1000,"hh");
            }
        });
